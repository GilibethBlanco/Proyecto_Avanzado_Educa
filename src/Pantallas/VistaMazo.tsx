...
export default function VistaMazo() {
  const [cartas, setCartas] = useState<CartaTipo[]>([
    ...
    },
    {
      ...
      descripcion: "Mutante con habilidades para manipular la energía",
    ...
    },
    {
      numero: 5,
      nombre: "Spider-Man",
      descripcion: "Adolescente mordido por una araña",
  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
        {cartas.map((carta) => (
          <Carta key={carta.numero} carta={carta} onSeleccionar={setCartaSeleccionada} />
        ))}
      </div>
